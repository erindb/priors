...
var get_items = function() {
	...
	var items = [
		...
		},
		{
			...
			story: "X commuted for K minutes",
			gender: "female",
			min: 0,
			max: 98,
			bins: [
		...
		},
		{
			...
			story: "X watched TV for K hours",
			gender: "male",
			min: 0,
			max: 43,
			bins: [
		...
		},
		{
			...
			give_number_question: "What do you think the temperature of X's coffee is?",
			binned_histogram_prompt: "Please rate how likely it is that X's coffee was the following temperatures.",
			story: "X's coffee was K",
			gender: "male",
			min: 0,
			max: 200,
			bins: [
