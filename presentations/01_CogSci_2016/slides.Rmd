...
- binned histogram task

<span style = "color:white"> &nbsp; </span>

<span style = "color:firebrick">Bayesian data analysis</span>

- infer population-level and subjective beliefs from data
...
- BH task averages are practical and reasonable approximations of the popuation-level central tendency of individual beliefs
- Bayesian data analysis is a great tool to extract information from multiple sources (e.g., data from different task types)

<span style = "color:white"> dummy </span>

<span style = "color:firebrick">specific</span>

- hierarchical modeling of population-level beliefs seems possible
